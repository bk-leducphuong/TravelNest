  ...
  <div class="search">
    <div class="container">
      <div class="search-bar">
        <!-- Location input -->
        <input type="text" class="search-input" v-model="selectedLocation" placeholder="Bạn muốn đến đâu?" @click="toggleLocationPopup" v-click-outside="hideLocationPopup">
        
        <!-- Location popup -->
        <div class="location-popup" v-if="showLocationPopup" >
          <h3>Điểm đến được ưa thích gần đây</h3>
          <ul class="location-list">
            <li class="location-item" v-for="location in locations" :key="location.name" @click="selectLocation(location)">
        ...
        <div class="date-picker">
          <input class="search-input" type="text" placeholder="Nhận phòng - Trả phòng" v-model="dateRange" ref="dateInput" >
        </div>

        <!-- Guest room input -->
        <div class="guest-room-wrapper">
          <input type="text" v-model="guestDetails" class="search-input" @click="toggleGuestSelector" readonly v-click-outside="hideGuestSelector">
  ...
  mounted() {
     flatpickr(this.$refs.dateInput, {
            ...
            onChange: function (selectedDates, dateStr, instance) {
                // Xử lý sự kiện sau khi chọn ngày (tuỳ chọn)
...
/* slide  */
    ...
    .slick-prev::before, .slick-after::before{
        color: #fff;
    }
