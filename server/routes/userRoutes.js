...
const { getUserInformation, getBookingInformation, editName, editDisplayName, editEmail, editPhoneNumber, editDateOfBirth, editAddress, editNationality, editGender, editAvatar } = require( '../controllers/userController.js');
